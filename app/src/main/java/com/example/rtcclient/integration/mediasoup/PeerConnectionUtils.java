package com.example.rtcclient.integration.mediasoup;
...
/**
 * PeerConnectionUtils is the integration point wtih mediasoup-client-android
 * which binds both local and remote video/audio tracks with the rest of the app.
 * Directly copied from mediasoup-demo-android and slightly modified to stop/start the camera
 */
